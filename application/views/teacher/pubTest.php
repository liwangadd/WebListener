    ...
    <div class="main-content">
        <div class="main-content-inner">
            ...
            <div class="page-content">
                <div class="row">
                    <div class="col-xs-12">
                        <form name="addcontent" action="<?php echo site_url("teacher/doPubTest")?>" method="post" enctype="multipart/form-data"
                              onsubmit="return checkSubmit();">
                            <div class="form-group">
                                <label>试卷标题：</label>
                                <input name="title" type="text" id="title" class='form-control-width-title form-control'
